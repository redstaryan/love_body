...
- (void)refreshFram{
    ...
    if (self.contentSize.height>self.frame.size.height-self.wordNumLabel.frame.size.height-5) {
        CGFloat wordNumLabelX = self.frame.size.width - self.wordNumLabel.frame.size.width-5;
        CGFloat wordNumLabelY = self.contentSize.height+self.contentInset.bottom-self.wordNumLabel.frame.size.height-5;
        
        self.wordNumLabel.frame = CGRectMake(wordNumLabelX, wordNumLabelY, self.wordNumLabel.frame.size.width, self.wordNumLabel.frame.size.height);
